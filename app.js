...
var budgetController = (function() {
     ...
     var data = {
         ...
         budget: 0,
         percentage: -1 //Value used to say that it doesn't exist
     };
...
var UIController = (function() {
    ...
    return {
        ...
        addListItem: function(obj, type) {
            ...
            //Creates a HTML string with placeholder text 
            if (type === 'inc') {
        ...
        clearFields: function() {
            ...
            //Loops through all the elements in the field and changes their value to ""
...
var appController = (function(budgetCtrl, UICtrl) {
    var setupEventListeners = function() {
        ...
        document.querySelector(DOM.inputType).addEventListener('change', UICtrl.changedTyp);
    };
